<template>
  <transition name="slide">
    <div class="user-center">
      ...
      <div class="play-btn" ref="playBtn" @click="randomPlayList">
        <i class="icon-play"></i>
      ...
      <div class="without-result-wrapper" v-show="withoutResult">
        <without-result :text="withoutResultDes"></without-result>
      </div>
    </div>
  </transition>
</template>
